/**
 * Zod schemas for the /api/positions, /api/analyze, /api/pre-market,
 * and /api/snapshot endpoint cluster, plus the structured-output
 * `analysisResponseSchema` we hand to Anthropic via tool_use.
 */

import { z } from 'zod';
import { num, str, bool } from './common.js';
