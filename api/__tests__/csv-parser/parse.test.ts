...
/**
 * Unit tests for api/_lib/csv-parser/parse.ts.
 *
 * Focus: CSV tokenization, section detection, and section parsing —
 * everything that lands a value in the `ParsedCSV` shape. The audit
 * items from docs/superpowers/specs/principal-engineer-audit-2026-04-07.md
 * exercised through the public `parseFullCSV` entry point also live here:
 *
 ...
 *
 * The summary/Claude-context layer lives in `./summary.test.ts`.
 */
