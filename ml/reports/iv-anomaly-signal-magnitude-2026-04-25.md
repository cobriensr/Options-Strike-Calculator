...
**Key question:** does signal _strength_ (e.g. 5σ z-score) predict better outcomes than signal _presence_ alone? Phase C answered the count question (no). This answers magnitude.
