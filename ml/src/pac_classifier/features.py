...
NQ-only by design — cross-asset enrichment was evaluated and rejected
(no equity 1m data available without a paid subscription the user
won't take on). The classifier learns from PAC engine state +
NQ-derived rolling features alone.

Feature taxonomy emitted (target: 20-25 cols):
