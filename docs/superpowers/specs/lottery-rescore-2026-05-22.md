...
| 7 | **Audit inferred_structure outliers FIRST (blocks v1)** | Phase 0 includes a script to inspect the p99 tail and verify structure-tagged outliers are legitimate deep-OTM 0DTE hits, not enrichment errors. Result determines whether structure becomes a feature. |
