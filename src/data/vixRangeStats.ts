...
export const VIX_BUCKETS: readonly VIXBucket[] = [
  { label: 'VIX <12',  lo: 0,  hi: 12, count: 806,  medHL: 0.54, avgHL: 0.62, p90HL: 1.03, medOC: 0.24, avgOC: 0.34, p90OC: 0.76, over1HL: 11.2, over2HL: 0.1, over1OC: 4.7,  zone: 'go' },
  { label: 'VIX 12\u201315', lo: 12, hi: 15, count: 2075, medHL: 0.68, avgHL: 0.76, p90HL: 1.22, medOC: 0.31, avgOC: 0.41, p90OC: 0.92, over1HL: 19.8, over2HL: 0.8, over1OC: 7.4,  zone: 'go' },
  { label: 'VIX 15\u201318', lo: 15, hi: 18, count: 1862, medHL: 0.87, avgHL: 0.95, p90HL: 1.50, medOC: 0.41, avgOC: 0.54, p90OC: 1.17, over1HL: 38.2, over2HL: 3.0, over1OC: 14.7, zone: 'go' },
  { label: 'VIX 18\u201320', lo: 18, hi: 20, count: 918,  medHL: 1.08, avgHL: 1.17, p90HL: 1.81, medOC: 0.57, avgOC: 0.69, p90OC: 1.47, over1HL: 57.5, over2HL: 6.2, over1OC: 24.2, zone: 'caution' },
  { label: 'VIX 20\u201325', lo: 20, hi: 25, count: 1827, medHL: 1.31, avgHL: 1.44, p90HL: 2.28, medOC: 0.66, avgOC: 0.82, p90OC: 1.72, over1HL: 73.3, over2HL: 16.0, over1OC: 32.3, zone: 'caution' },
  { label: 'VIX 25\u201330', lo: 25, hi: 30, count: 864,  medHL: 1.70, avgHL: 1.84, p90HL: 2.85, medOC: 0.85, avgOC: 1.05, p90OC: 2.29, over1HL: 89.4, over2HL: 35.2, over1OC: 43.2, zone: 'stop' },
  { label: 'VIX 30\u201340', lo: 30, hi: 40, count: 529,  medHL: 2.17, avgHL: 2.34, p90HL: 3.73, medOC: 1.08, avgOC: 1.39, p90OC: 3.00, over1HL: 96.4, over2HL: 57.7, over1OC: 52.9, zone: 'danger' },
  { label: 'VIX 40+',   lo: 40, hi: 999, count: 221, medHL: 3.62, avgHL: 4.08, p90HL: 7.16, medOC: 2.00, avgOC: 2.45, p90OC: 5.09, over1HL: 98.6, over2HL: 87.8, over1OC: 73.3, zone: 'danger' },
] as const;
...
export const SURVIVAL_DATA: readonly SurvivalData[] = [
  { wing: 0.50, label: '\u00B10.50%', settle: [76.6, 69.4, 57.2, 45.6, 39.2, 31.1, 21.6, 11.8], intraday: [88.8, 80.2, 61.8, 42.5, 26.7, 10.6, 3.6, 1.4] },
  { wing: 0.75, label: '\u00B10.75%', settle: [89.5, 83.6, 74.3, 62.6, 54.8, 46.3, 34.8, 19.5], intraday: [98.6, 96.3, 90.1, 79.2, 62.7, 37.5, 17.6, 2.7] },
  { wing: 1.00, label: '\u00B11.00%', settle: [95.3, 92.6, 85.3, 75.8, 67.7, 56.8, 47.1, 26.7], intraday: [99.9, 99.2, 97.0, 93.8, 84.0, 64.8, 42.3, 12.2] },
  { wing: 1.25, label: '\u00B11.25%', settle: [98.4, 96.6, 91.7, 84.6, 78.7, 66.2, 54.8, 33.5], intraday: [100, 99.9, 99.2, 98.0, 93.3, 81.8, 66.7, 21.3] },
  { wing: 1.50, label: '\u00B11.50%', settle: [99.8, 98.4, 95.2, 91.3, 85.2, 73.8, 62.6, 39.4], intraday: [100, 100, 99.7, 99.6, 97.5, 92.4, 80.0, 33.0] },
  { wing: 2.00, label: '\u00B12.00%', settle: [99.9, 99.7, 98.9, 97.6, 93.8, 86.1, 77.5, 49.8], intraday: [100, 100, 100, 99.9, 99.6, 99.0, 92.6, 62.0] },
] as const;
...
export const FINE_VIX_STATS: readonly FineVIXStat[] = [
  { vix: 10, count: 207, medHL: 0.51, p90HL: 0.94, medOC: 0.19, p90OC: 0.69, over2: 0.5 },
  { vix: 11, count: 529, medHL: 0.59, p90HL: 1.09, medOC: 0.26, p90OC: 0.86, over2: 0.0 },
  { vix: 12, count: 742, medHL: 0.62, p90HL: 1.12, medOC: 0.27, p90OC: 0.85, over2: 0.3 },
  { vix: 13, count: 735, medHL: 0.69, p90HL: 1.21, medOC: 0.31, p90OC: 0.91, over2: 0.8 },
  { vix: 14, count: 598, medHL: 0.76, p90HL: 1.34, medOC: 0.37, p90OC: 1.01, over2: 1.5 },
  { vix: 15, count: 636, medHL: 0.83, p90HL: 1.42, medOC: 0.41, p90OC: 1.12, over2: 2.4 },
  { vix: 16, count: 684, medHL: 0.86, p90HL: 1.49, medOC: 0.41, p90OC: 1.14, over2: 2.9 },
  { vix: 17, count: 542, medHL: 0.92, p90HL: 1.58, medOC: 0.41, p90OC: 1.24, over2: 3.9 },
  { vix: 18, count: 435, medHL: 1.09, p90HL: 1.80, medOC: 0.54, p90OC: 1.47, over2: 5.5 },
  { vix: 19, count: 483, medHL: 1.08, p90HL: 1.85, medOC: 0.57, p90OC: 1.47, over2: 6.8 },
  { vix: 20, count: 426, medHL: 1.25, p90HL: 2.05, medOC: 0.68, p90OC: 1.49, over2: 11.0 },
  { vix: 21, count: 405, medHL: 1.22, p90HL: 2.10, medOC: 0.59, p90OC: 1.67, over2: 12.3 },
  { vix: 22, count: 378, medHL: 1.29, p90HL: 2.22, medOC: 0.63, p90OC: 1.73, over2: 14.8 },
  { vix: 23, count: 317, medHL: 1.39, p90HL: 2.40, medOC: 0.70, p90OC: 1.79, over2: 20.8 },
  { vix: 24, count: 301, medHL: 1.51, p90HL: 2.54, medOC: 0.74, p90OC: 2.02, over2: 24.6 },
  { vix: 25, count: 246, medHL: 1.62, p90HL: 2.69, medOC: 0.75, p90OC: 2.23, over2: 28.5 },
  { vix: 26, count: 177, medHL: 1.59, p90HL: 2.81, medOC: 0.85, p90OC: 1.98, over2: 28.8 },
  { vix: 27, count: 159, medHL: 1.81, p90HL: 3.04, medOC: 0.90, p90OC: 2.48, over2: 40.9 },
  { vix: 28, count: 160, medHL: 1.77, p90HL: 2.96, medOC: 0.86, p90OC: 2.35, over2: 38.1 },
  { vix: 29, count: 122, medHL: 1.97, p90HL: 2.76, medOC: 1.08, p90OC: 2.28, over2: 46.7 },
  { vix: 30, count: 91,  medHL: 1.88, p90HL: 3.23, medOC: 1.20, p90OC: 2.62, over2: 48.4 },
] as const;
 ...
 */
export function getSurvival(vix: number, wingPct: number): { settle: number; intraday: number } | null {
...
export function estimateRange(vix: number): RangeEstimate {
  ...
  if (vix > 30) {
    ...
    if (bucket) {
      return { medHL: bucket.medHL, medOC: bucket.medOC, p90HL: bucket.p90HL, p90OC: bucket.p90OC };
    }
  }
  ...
  if (!lo || !hi || lo.vix === hi.vix) {
    ...
    return { medHL: stat.medHL, medOC: stat.medOC, p90HL: stat.p90HL, p90OC: stat.p90OC };
  }
