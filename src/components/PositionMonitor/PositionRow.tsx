/**
 * PositionRow — Desktop <tr> renderers for the position table.
 *
 * Mobile card variants (IronCondorCard / SpreadCard / ButterflyCard /
 * HedgeCards / NakedCards) live in the sibling `PositionCards.tsx`.
 *
 * Exports: IronCondorRow, SpreadRow, ButterflyRow, HedgeRows, NakedRows.
