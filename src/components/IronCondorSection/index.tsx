  ...
  return (
    <div className="mt-4.5">
      <div
        ...
        role="button"
        tabIndex={0}
        aria-label={`Toggle Iron Condor (${wingWidth}-pt wings)`}
      ...
      {!collapsed && (
        <>
          ...
          <p className="text-muted mt-2 text-[11px] italic">
            ...
            put. Call spread = sell short call / buy long call. Iron Condor =
            both spreads combined. Individual spread PoP is single-tail (higher
            than IC). IC PoP = P(price between both BEs), not the product of
            spread PoPs. Premiums theoretical (r=0).
          </p>
