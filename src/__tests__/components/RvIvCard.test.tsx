...
describe('RvIvCard', () => {
  it('renders the ratio value', () => {
    render(
      <RvIvCard ratio={0.72} label="IV Rich" rvAnnualized={0.14} iv={0.19} />,
    );
  ...
  it('renders IV Cheap label and advice', () => {
    render(
      <RvIvCard ratio={1.35} label="IV Cheap" rvAnnualized={0.27} iv={0.2} />,
    );
  ...
  it('renders Fair Value label and advice', () => {
    render(
      <RvIvCard ratio={0.95} label="Fair Value" rvAnnualized={0.19} iv={0.2} />,
    );
  ...
  it('renders the section title', () => {
    render(
      <RvIvCard ratio={1.0} label="Fair Value" rvAnnualized={0.2} iv={0.2} />,
    );
