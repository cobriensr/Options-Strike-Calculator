...
- Evaluate against: correctness, pattern adherence (AGENTS.md conventions), code quality, test coverage, side effects
...
Never edit `.env*` files with Codex. Never commit secrets.
