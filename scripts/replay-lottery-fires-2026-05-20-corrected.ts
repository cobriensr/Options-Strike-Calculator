 ...
 * 2026-05-20 — CORRECTED regeneration. The original 2026-05-20 replay
 ...
 * detectChainFires's 4th arg. ws_option_trades for 2026-05-20 was pruned
 ...
 *
 * Walks minute-by-minute through 13:30 UTC → 20:30 UTC (8:30 → 15:30 CT),
 ...
 *   npx tsx scripts/replay-lottery-fires-2026-05-20-corrected.ts            # dry-run
 *   npx tsx scripts/replay-lottery-fires-2026-05-20-corrected.ts --apply    # writes
 */
...
const REPLAY_DAY_ET = '2026-05-20';
const REPLAY_START_UTC = new Date('2026-05-20T13:30:00Z');
const REPLAY_END_UTC = new Date('2026-05-20T20:30:00Z');
