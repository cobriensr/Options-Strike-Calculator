...
// Iterate every ticker carried by the post 2026-04-25 multi-theme-
// expansion fixture. Order matches STRIKE_IV_TICKERS (13 tickers) — the
// quiet tickers (everything except SPY/QQQ) should produce zero flags in
// the replay; SPY/QQQ are the only ones with target trajectories. Quiet-
// baseline data for the rest is provided by the fixture builder (flat
// IV, sub-5× vol/OI).
const TICKERS = [
  'SPXW',
  'NDXP',
